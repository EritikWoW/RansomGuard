...
This document describes the default Audit guided setup. Version 0.8.2 adds the protocol-v18 ProductionGate contract on top of package admission, but the guided setup still does not install/load the production kernel driver, spawn/supervise GateClient or claim active blocking. It does not change Defender or widen trust rules.
