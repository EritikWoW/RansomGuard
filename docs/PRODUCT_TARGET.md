...
The next core milestones are section-synchronization attestation plus coverage for writable mappings backed by handles that predate gate activation, deeper crash recovery for requests interrupted before authoritative kernel completion delivery,
