...
public static class AdminContract
{
    ...
    private static readonly string[] Actions = ["rules", "add", "edit", "disable", "remove", "install", "update", "update-recovery", "start", "stop", "restart", "uninstall", "state-repair", "recovery-review"];
    ...
    public static string Confirmation(string action, string? sha256 = null) => action switch
    {
        ...
        "disable" => "DISABLE", "remove" => "REMOVE", "install" => "INSTALL", "update" => "UPDATE", "update-recovery" => "ROLLBACK UPDATE",
