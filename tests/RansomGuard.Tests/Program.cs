...
try
{
    ...
    ledger.RecordSuspendCompleted(ledgerRequestId);
    ...
    ledger.RecordResumeOwned(ledgerRequestId,9002);
    ...
    ledger.RecordFailed(failureRequestId,"SyntheticPartialFailure");
