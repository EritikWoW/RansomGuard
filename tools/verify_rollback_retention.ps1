...
foreach($required in @(
    ...
    'deleteStore.UnsettledIntents.Count',
...
foreach($required in @(
    ...
    'new DeleteOperationStore(deleteRoot).UnsettledIntents.Count',
    'pending CREATE/RENAME/TRUNCATE/DELETE transaction evidence',
