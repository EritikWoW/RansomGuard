...
Write-Host 'Runtime VM harness source gate PASSED: manual self-hosted VM only, exact-commit signed driver provenance, protocol-v18 protected-volume scope plus GateClient-loss fail-safe/reconnect/release coverage, mapping and containment coverage, no boot/trust/Defender mutation.' -ForegroundColor Green
