...
foreach($required in @(
    ...
    '`ContainmentSuspendCoordinator` is a second platform-neutral safety layer.',
    'Any cancellation, operation failure or unstable thread set attempts owned-only rollback',
    'A Windows adapter and disposable-VM proof are separate prerequisites',
